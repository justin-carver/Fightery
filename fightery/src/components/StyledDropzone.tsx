            ...
            <div className="StyledDropzone__dropzone" {...dragProps}>
                <div className="StyledDropzone__dropzone--info border-dashed border-2 dark:border-gray-400 hover:border-green-400 rounded-sm"  onClick={onImageUpload}>
                    <div className="StyledDropzone__dropzone--droptext">
                        <p className="tracking-wider opacity-60 rounded-sm p-1"><span className="hover:font-bold hover:opacity-100">Click</span> or Drop 👇 to Add New Players</p>
                        <p className="tracking-wide text-lg">or</p>
                        <button className="tracking-wider opacity-60 hover:bg-error rounded-sm p-1" onClick={onImageRemoveAll}>Reset All Players</button>
                    </div>
                </div>
                    ...
                    {imageList.map((image, index) => (
                        <motion.div initial="hidden" animate="visible" variants={variants} key={index} className="image-item__wrapper">
                            ...
                            <div className="image-item__info">
                                ...
                                <input className="image-item__info--name dark:text-white dark:bg-[#4f5275] p-2 tracking-wider text-center required:border-red-500" required={true} type="text" placeholder="Player Name" />
